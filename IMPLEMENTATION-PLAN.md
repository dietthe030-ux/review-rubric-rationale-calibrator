...
6. Before PRE_DEPLOY review, lock the Studio RPC measurement mode and minimum-sufficient Studio matrix; after approval, deploy once, execute that approved matrix, and obtain POST_DEPLOY_TEST approval.
